...
typedef enum
{
  ...
  CUSTOM_STM_CMD,
  CUSTOM_STM_ALL_SENS,
  CUSTOM_STM_DEVICE_INFO,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* IMU_ACCEL */
  CUSTOM_STM_ACCEL_S_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_ACCEL_S_NOTIFY_DISABLED_EVT,
  /* ECG_SENSOR */
  CUSTOM_STM_ECG_S_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_ECG_S_NOTIFY_DISABLED_EVT,
  /* COMMAND */
  CUSTOM_STM_CMD_WRITE_EVT,
  /* ALL_SENSOR */
  CUSTOM_STM_ALL_SENS_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_ALL_SENS_NOTIFY_DISABLED_EVT,
  /* READ_DEVICE_INFO */
  CUSTOM_STM_DEVICE_INFO_READ_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeAccel_S;
extern uint16_t SizeEcg_S;
extern uint16_t SizeCmd;
extern uint16_t SizeAll_Sens;
extern uint16_t SizeDevice_Info;
