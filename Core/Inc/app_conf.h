 ...
 */
#define CFG_GAP_DEVICE_NAME             "Neuranics"
...
#define L2CAP_INTERVAL_MIN              CONN_P(10) 		/* 10ms */
#define L2CAP_INTERVAL_MAX              CONN_P(15) 		/* 12.5ms */
#define L2CAP_PERIPHERAL_LATENCY        0x0000
#define L2CAP_TIMEOUT_MULTIPLIER        0x1F4			// 10s
 ...
 */
#define CFG_BLE_MAX_ATT_MTU             (225)
...
#define CFG_BLE_MIN_TX_POWER            (-10)

#define CFG_BLE_MAX_TX_POWER            (3)
 ...
 */
#define CFG_TLBLE_EVT_QUEUE_LENGTH 25
/**
...
#define CFG_BLE_MAX_ATT_MTU             (225)		//225
